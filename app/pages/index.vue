<template>
  <main class="min-h-screen bg-gray-50 text-gray-900">
    <section class="mx-auto max-w-5xl px-6 py-16">
      <h1 class="text-3xl font-bold tracking-tight sm:text-4xl">ContentPlanner</h1>
      <p class="mt-3 max-w-2xl text-base text-gray-600">
        Planifie, rédige et publie ton contenu multi-plateformes. RBAC, calendrier collaboratif,
